...
class foobar2000Data(FeedUpdateData):
    def getCheckUrl():
        return 'http://www.foobar2000.org/download'
    ...
    def setBody(self, body):
        ...
        p = re.compile('foobar2000\s*(v[\d\.]+)', re.DOTALL)
...
def main():
    return FeedUpdate(__file__, 'http://www.foobar2000.org/').run()
