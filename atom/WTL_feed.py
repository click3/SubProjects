...
class WTLData(FeedUpdateData):
    def getCheckUrl():
        return 'http://sourceforge.net/projects/wtl/'
    ...
    def setBody(self, body):
        ...
        p = re.compile('WTL\s*(\d\.\d\.[\d\.]+)', re.DOTALL)
...
def main():
    return FeedUpdate(__file__, 'http://sourceforge.net/projects/wtl/').run()
