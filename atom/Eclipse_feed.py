...
class EclipseData(FeedUpdateData):
    def getCheckUrl():
        return 'http://www.eclipse.org/downloads/'
    ...
    def setBody(self, body):
        ...
        p = re.compile('Eclipse\s*([A-Z][a-z]+\s*\([\d.]+\))', re.DOTALL)
...
def main():
    return FeedUpdate(__file__, 'http://www.eclipse.org/').run()
